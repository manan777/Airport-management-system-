...
//         $sql ="SELECT ssn,fname,m,lname,address,phone,age,sex
//   from employee1 
//   where fname = '$name'";
           //echo $sql;
           //echo $name;
   ...
   if(mysqli_num_rows($result) >0)
    {
        ...
        while($row = $result->fetch_assoc()){
            //print"<pre>";
   //print_r($row);
             echo"<tr><td>".$row["ssn"]."</td><td>".$row["fname"]."</td><td>".$row["m"]."</td><td>".$row["lname"]."</td><td>".$row["address"]."</td><td>".$row["phone"]."</td><td>".$row["age"]."</td><td>".$row["sex"]."</td></tr>";
     }
    echo"</table>";
    }
        else{

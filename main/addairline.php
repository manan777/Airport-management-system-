...
<link rel="stylesheet" href="style.css" />
    <style>
        body{
            background-image: url(https://images.unsplash.com/photo-1483450388369-9ed95738483c?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60);
...
<h2> <p>Enter a new airline</p></h2> 
    <form action="addairline1.php" method='post' name="city">
<input type="text" class="in" name="airlineid" placeholder="enter airlineid" required />
   <input type="text" class="in" name="al_name" placeholder="enter airline name" required />
         <input type="text" class="in" name="three_digit_code" placeholder="enter code" required />

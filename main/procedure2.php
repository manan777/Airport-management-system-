   ...
   if(mysqli_num_rows($result) >0)
    {
        ...
        while($row = $result->fetch_assoc()){
              echo"<tr><td>".$row["pid"]."</td><td>".$row["passportno"]."</td><td>".$row["fname"]."</td><td>".$row["m"]."</td><td>".$row["lname"]."</td><td>".$row["address"]."</td><td>".$row["phone"]."</td><td>".$row["age"]."</td><td>".$row["sex"]."</td><td>".$row["flight_code"]."</td></tr>";
     }
    echo"</table>";
    }
        else{

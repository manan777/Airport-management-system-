...
<body>
    <h2>TICKET CANCELLATION HISTORY</h2>
...
require('db.php');
session_start();
   $sql ="SELECT ticket_number,date_of_cancellation,surcharge from ticket3";
   $result = mysqli_query($con,$sql) or die(mysql_error());
    if($result-> num_rows >0)
    {
        while($row = $result->fetch_assoc()){
            echo"<tr><td>".$row["ticket_number"]."</td><td>".$row["date_of_cancellation"]."</td><td>".$row["surcharge"]."</td></tr>";
